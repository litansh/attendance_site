...
<head>
    <meta charset="UTF-8">
    <title>Revoke admin permissions</title>
...
Revoke admin permissions
    ...
    <div class="row">
        <div class="col-md-5 col-md-offset-3 well">
            <h4>Revoke admin permissions</h4>
            <?php
            if ($register_error_message != "") {
                echo '<div class="alert alert-danger"><strong>Error: </strong> ' . $register_error_message . '</div>';
            }
            ?>
            <form action="revokeadmin.php" method="post">
                ...
                <div class="form-group">
                    <input type="submit" name="btnRegister" class="btn btn-primary" value="Revoke permission"/>
                </div>
            </form>
                 </div>
                 <div>
...
function myFunction() {
  document.getElementById("expand").innerHTML = "<?php UsersExpand(); ?>";
    ...
    <div class="col-md-12 alert alert-success">
            ...
            <div class="col-md-12 alert alert-success">
                Promote user to admin? <a href="adminregistration.php">Press Here</a>
            </div>
    </div>
    <div class="row">
        <div class="col-md-12 alert alert-success">
